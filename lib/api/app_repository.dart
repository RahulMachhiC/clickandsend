...
// Check Moblie Number
  ...
  Future<dynamic> confirmjob({
    required String accessToken,
    required String id,
    required String driverId,
  }) async {
    String url = "api/auth/jobs/confirm-job";
    final response = await helper.post(
      url,
      {
        "id": id,
  ...
  Future<dynamic> completeJob({
    required String accessToken,
    required String id,
    required String driverId,
  }) async {
    String url = "api/auth/jobs/complete-job";
    final response = await helper.post(
      url,
      {
        "id": id,
  ...
  Future<dynamic> fetchdriverplan({
    ...
    final response = await helper.get(
      "api/auth/master/plan/list/$usertype/1",
      {
        "Accept": "application/json",
        "Authorization": "Bearer $accesstoken",
      },
