...
class AppDrawerJob extends StatefulWidget {
  ...
  @override
  State<AppDrawerJob> createState() => _AppDrawerJobState();
}

class _AppDrawerJobState extends State<AppDrawerJob> {
  ...
  void _handleDrawerItemTap(DrawerItemType type) {
    switch (type) {
      case DrawerItemType.JOB_DETAIL:
        break;
