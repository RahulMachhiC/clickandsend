...
import 'package:click_send/screens/driver/adddriver.dart';
...
class _AppDrawerState extends State<AppDrawer> {
  ...
  void _handleDrawerItemTap(DrawerItemType type) {
    switch (type) {
      ...
      case DrawerItemType.ADD_DRIVER:
        Navigator.push(
          context,
          MaterialPageRoute(
        ...
        break;
      case DrawerItemType.SUBSCRIPTION:
        Navigator.push(
          context,
          MaterialPageRoute(
...
final drawerItems = <DrawerItem>[
  ...
  // const DrawerItem(
  //   icon: "assets/images/driverlist.svg",
  //   text: 'Driver List',
  //   type: DrawerItemType.DRIVER_LIST,
  // ),
  DrawerItem(
    icon: "assets/images/adddriver.svg",
    text: 'Add Driver',
    type: DrawerItemType.ADD_DRIVER,
  ),
  const DrawerItem(
    icon: "assets/images/subscription.svg",
    text: 'Subscription',
    type: DrawerItemType.SUBSCRIPTION,
  ),
  const DrawerItem(
