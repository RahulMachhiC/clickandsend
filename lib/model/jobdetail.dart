class JobDetail {
  ...
  JobDetail.fromJson(Map<String, dynamic> json) {
    viewData = json['view_data'] != dynamic
...
class ViewData {
  ...
  ViewData.fromJson(Map<String, dynamic> json) {
    job = json['job'] != dynamic ? new Job.fromJson(json['job']) : null;
    if (json['pickup'] != dynamic) {
      pickup = <Pickup>[];
      json['pickup'].forEach((v) {
        pickup!.add(new Pickup.fromJson(v));
      });
    }
    if (json['drop'] != dynamic) {
      drop = <Drop>[];
      json['drop'].forEach((v) {
        drop!.add(new Drop.fromJson(v));
      });
    }
    if (json['ratings'] != dynamic) {
      ratings = <Ratings>[];
...
class Drop {
  ...
  Drop.fromJson(Map<String, dynamic> json) {
    ...
    item = json['item'] != dynamic ? new Item.fromJson(json['item']) : null;
...
class Pickup {
  ...
  Pickup.fromJson(Map<String, dynamic> json) {
    ...
    jobId = json['job_id'];
    jobitemId = json['jobitem_id'];
    item = json['item'] != dynamic ? Item.fromJson(json['item']) : null;
    address = json['address'];
    lat = json['lat'];
    long = json['long'];
    type = json['type'];
...
//     id = json['id'];
//     userId = json['user_id'];
//     user = json['user'] != dynamic ? new User.fromJson(json['user']) : dynamic;
//     jobId = json['job_id'];
//     givenBy = json['given_by'];
//     review = json['review'];
//     rating = json['rating'];
