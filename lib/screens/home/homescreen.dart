...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void callapi() {
    ...
    if (preferences!.getString("usertype") == "driver") {
      context.read<HomeProvider>().getdrivercounts(
            context: context,
          );
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<HomeProvider>(builder: (context, provider, child) {
        ...
        } else if (provider.isloading == false && provider.activejobs != null) {
          OverlayLoadingProgress.stop();
                          ...
                          child: preferences!.getString("usertype") == "company"
                                                                ...
                                                                children: [
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        provider.driverList!.viewData!.data!.elementAt(index).mobile!.isNotEmpty
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        "  " +
                                                                            provider.driverList!.viewData!.data!.elementAt(index).runningjob!.toString() +
                                                                            " Running",
                                                                        style: GoogleFonts
                                                                            .inter(
                                                                          color:
                              ...
                              : ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    return InkWell(
                                      onTap: () {
                                        if (provider.activejobs!.viewData!.data!
                                                .elementAt(index)
                                                .items ==
                                            null) {
                                          MotionToast(
                                          ...
                                          if (provider
                                            ...
                                            showDialog(
                                              ...
                                              builder: (context) => AlertDialog(
                                                title: Text(
                                                  "Are you sure you want to confirm job?",
                                                  style: GoogleFonts.inter(
                                                    color: Colors.black,
                                                    fontSize: 15.sp,
                                                    fontWeight: FontWeight.w600,
                                            ...
                                            Navigator.push(
                                              ...
                                              MaterialPageRoute(
                                                builder: (context) =>
                                                    TakingImagePickup(
                                                  bidid: provider.activejobs!
                                                      .viewData!.data!
                                                      .elementAt(index)
                                                      .bidId
                                                      .toString(),
                                                  itemid: provider.activejobs!
                                                      .viewData!.data!
                                                      .elementAt(index)
                                                      .items!
                                                      .first
                                                                ...
                                                                children: [
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        provider.activejobs!.viewData!.data!.elementAt(index).items!.isNotEmpty
                                                                            ? "  ${provider.activejobs!.viewData!.data!.elementAt(index).items!.first.product!.material}"
                                                                            : "",
                                                                        style: GoogleFonts
                                                                            .inter(
                                                                          color:
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        provider.activejobs!.viewData!.data!.elementAt(index).items!.isNotEmpty
                                                                            ? "  ${provider.activejobs!.viewData!.data!.elementAt(index).items!.first.product!.length}x${provider.activejobs!.viewData!.data!.elementAt(index).items!.first.product!.width}x${provider.activejobs!.viewData!.data!.elementAt(index).items!.first.product!.height}"
                                                                            : "",
                                                                        style: GoogleFonts
                                                                            .inter(
                                                                          color:
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        provider.activejobs!.viewData!.data!.elementAt(index).items!.isNotEmpty
                                                                            ? "  ${provider.activejobs!.viewData!.data!.elementAt(index).items!.first.product!.quantity} Qty"
                                                                            : "",
                                                                        style: GoogleFonts
                                                                            .inter(
                                                                          color:
                                  ...
                                  itemCount: provider
                                          .activejobs?.viewData!.data!.length ??
                                      0,
                                ),
                        ),
                      ],
